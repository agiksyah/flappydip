...
function preload() {
    var assets = {
        ...
        audio: {
            ...
            hurt: ['assets/splash.wav'],
            pipe: ['assets/smash.wav']
        }
    };
...
function reset() {
    ...
    instText.setText("SENTUH LAYAR GAWAI\nANDA");
